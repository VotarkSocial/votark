...
export const PASSWORD_RESET_PROCESS_STARTED = 'PASSWORD_RESET_PROCESS_STARTED';
export const PASSWORD_RESET_PROCESS_COMPLETED = 'PASSWORD_RESET_PROCESS_COMPLETED';
export const PASSWORD_RESET_PROCESS_FAILED = 'PASSWORD_RESET_PROCESS_FAILED';